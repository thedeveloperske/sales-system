    ...
    <form id="showmembers">
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                ...
                $sql = "SELECT * from history where book_returned <> 1";
                ...
                <div class='inner'>
                    <?php
                    $query = "SELECT * from history where book_returned <> 1";
                    ...
                    while ($row = mysqli_fetch_array($results)) {
                        ...
                        $nme = $row["book_id"];
                        $gender = $row["issue_date"];
                        $mobno = $row["return_date"];
                        $email = $row["fine"];


                        $sql = "SELECT * FROM history WHERE admission_no ='$adm' and book_returned <> 1";
                        ...
                        echo "<tr><td style='text-transform: uppercase;'>" . ($adm) . "</td> 
							...
							<td>" . ($email) . "</td>
								...
								<td><a href='fines.php?id=" . $adm . "' id='btn'>Confirm Return</a></td>  
